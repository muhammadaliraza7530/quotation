...
import { InvoiceCreateSchema, PaginationQuerySchema } from "@/lib/schemas";
      ...
      createHandlers({
        ...
        POST: async ({ request, context }) => {
          try {
            ...
            const data = validateBody(body, InvoiceCreateSchema);
            const insertPayload: z.infer<typeof InvoiceCreateSchema> & {
              user_id: string;
